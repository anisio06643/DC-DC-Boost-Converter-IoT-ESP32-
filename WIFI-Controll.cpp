...
void handleStatus() {
    ...
    State::lastVolts = (analogRead(Hardware::vSensePin) / 4095.0) * 3.3 * 24.0; // Assuming 1:24 divider
...
void loop() {
    ...
    if (millis() - lastRamp > 2) { // Ramp duty every 2ms
